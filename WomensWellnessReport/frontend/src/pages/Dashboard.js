...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard">
      ...
      {/* Entry Count Info */}
      {entryCount > 0 && (
        <div className={`alert ${needsMoreForReports ? 'alert-info' : 'alert-success'}`} style={{ marginBottom: '20px' }}>
          <strong>📊 Data Status:</strong> You have {entryCount} {entryCount === 1 ? 'entry' : 'entries'} saved.
          {needsMoreForReports && (
            <span>
              <br />
              <small>
                💡 You need {3 - entryCount} more {3 - entryCount === 1 ? 'entry' : 'entries'} (for different dates) to see Reports and Cycle Forecasts. 
          ...
          <div className="card">
            ...
            <ResponsiveContainer width="100%" height={400}>
              <LineChart data={chartData.wellness_scores}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="score" stroke="#ffb3b3" strokeWidth={3} />
              </LineChart>
            </ResponsiveContainer>
          </div>
            ...
            <div className="card">
              ...
              <ResponsiveContainer width="100%" height={350}>
                <LineChart data={chartData.stress_levels}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="morning" stroke="#ffd9b3" strokeWidth={2} />
                  <Line type="monotone" dataKey="afternoon" stroke="#ffc7a3" strokeWidth={2} />
                  <Line type="monotone" dataKey="night" stroke="#ffb3b3" strokeWidth={2} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="card">
              ...
              <ResponsiveContainer width="100%" height={350}>
                <LineChart data={chartData.sleep_data}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar yAxisId="left" dataKey="hours" fill="#ffc7a3" />
                  <Line yAxisId="right" type="monotone" dataKey="quality" stroke="#ffd9b3" strokeWidth={3} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={chartData.exercise_data}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Bar dataKey="minutes" fill="#ffb3b3" />
                </BarChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={chartData.water_data}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Bar dataKey="intake" fill="#ffc7a3" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
